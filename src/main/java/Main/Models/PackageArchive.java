...
public class PackageArchive
{
    ...
    private StringProperty dataWykonania = new SimpleStringProperty();
    ...
    public PackageArchive(String akcja, String dataWykonania, int idZamowienia, int iloscPaczek, String statusPrzesylki, String imie, String nazwisko, String adres, String kodPocztowy, String miejscowosc, String telefon, String mail, String dodatkoweInformacje, String dataUtworzenia, String dostawca, String typDostawy)
    {
        setAkcja(akcja);
    ...
    public StringProperty dataWykonaniaProperty()
    {
    ...
    {
        this.dataWykonania.set(dataWykonania);
    }
